<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-02-03 13:29:14
         compiled from "D:\workspace\web\test_cms\application\templates\account.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3003854d094ea758922-91013062%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f90cb76b752bb41b48ea4f67ddffcc4f30af103d' => 
    array (
      0 => 'D:\\workspace\\web\\test_cms\\application\\templates\\account.tpl',
      1 => 1422625130,
      2 => 'file',
    ),
    '4e170e573f0f45f8912a2a801f68c3bacb31bdb3' => 
    array (
      0 => 'D:\\workspace\\web\\test_cms\\application\\templates\\controller.tpl',
      1 => 1422624251,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '3003854d094ea758922-91013062',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54d094eb330e59_03928278',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54d094eb330e59_03928278')) {function content_54d094eb330e59_03928278($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include 'D:\\workspace\\web\\test_cms\\application\\libs\\smarty\\plugins\\modifier.regex_replace.php';
if (!is_callable('smarty_mb_wordwrap')) include 'D:\\workspace\\web\\test_cms\\application\\libs\\smarty\\plugins\\shared.mb_wordwrap.php';
?><?php if (!isset($_smarty_tpl->tpl_vars['doc']->value)) {
...
<div class="content">
				<div class="title">
					<h1><?php echo smarty_modifier_regex_replace($_smarty_tpl->tpl_vars['doc']->value->head,"/(RUBETEK EVO)/i","<span>\$1</span>");?>
</h1>
					<div class="hr"></div>
				</div>
				<div class="preamble">
...
/file_content/<?php echo $_smarty_tpl->tpl_vars['doc']->value->img;?>
" alt="" />
                     <?php $_smarty_tpl->tpl_vars['l'] = new Smarty_variable($_smarty_tpl->tpl_vars['current_menu']->value, null, 0);?>
                     <?php while ($_smarty_tpl->tpl_vars['l']->value!=null) {?>
                         <?php $_smarty_tpl->tpl_vars['last'] = new Smarty_variable($_smarty_tpl->tpl_vars['l']->value, null, 0);?>
                     ...
                     <?php }?>
                        ...
                        <?php if (isset($_smarty_tpl->tpl_vars['last']->value)) {?>
                        	<?php echo smarty_mb_wordwrap($_smarty_tpl->tpl_vars['last']->value->name,20,"<br/>",false);?>
	...
	<img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
/file_content/<?php echo $_smarty_tpl->tpl_vars['docs']->value['account_second']->img;?>
" alt="" />
	...
	<div class="title">
		<h1><?php echo smarty_modifier_regex_replace($_smarty_tpl->tpl_vars['docs']->value['account_second']->head,"/(RUBETEK EVO)/i","<span>\$1</span>");?>
</h1>
		<div class="hr"></div>
	</div>
	<p class="desc"><?php echo $_smarty_tpl->tpl_vars['docs']->value['account_second']->s_content;?>
</p>
	...
	<div class="content">
		...
		<div class="main2">
         	<?php echo $_smarty_tpl->tpl_vars['docs']->value['account_second']->content;?>
