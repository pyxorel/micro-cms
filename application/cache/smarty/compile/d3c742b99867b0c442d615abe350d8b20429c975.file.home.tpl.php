<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-02-04 17:13:16
         compiled from "D:\workspace\web\__test_cms\application\templates\home.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1649854d21aec2c7a04-47676580%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd3c742b99867b0c442d615abe350d8b20429c975' => 
    array (
      0 => 'D:\\workspace\\web\\__test_cms\\application\\templates\\home.tpl',
      1 => 1422546161,
      2 => 'file',
    ),
    '4630f0b168f9f98c112cf3fcdf4c4261aa22308e' => 
    array (
      0 => 'D:\\workspace\\web\\__test_cms\\application\\templates\\master.tpl',
      1 => 1422616098,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1649854d21aec2c7a04-47676580',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54d21aeccfaff7_21152638',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54d21aeccfaff7_21152638')) {function content_54d21aeccfaff7_21152638($_smarty_tpl) {?><?php if (!isset($_smarty_tpl->tpl_vars['doc']->value)) {
...
<div class="banner">
				<div class="content">
					<h1><?php echo $_smarty_tpl->tpl_vars['doc']->value->head;?>
</h1>
				</div>
			</div>
			<div class="line left">
			...
			<div class="content">
				<div class="cols">
					<div class="col col2">
						<div class="slogons">
							<div class="s1">
								<span><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['resource'][0][0]->function_resource(array('name'=>'home_phrase1'),$_smarty_tpl);?>
</span>
								<span class="sh"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['resource'][0][0]->function_resource(array('name'=>'home_phrase1'),$_smarty_tpl);?>
</span>
							</div>
							<div class="s2">
								<span><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['resource'][0][0]->function_resource(array('name'=>'home_phrase2'),$_smarty_tpl);?>
</span>
								<span class="sh"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['resource'][0][0]->function_resource(array('name'=>'home_phrase2'),$_smarty_tpl);?>
</span>
							</div>
							<div class="s3">
								<span><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['resource'][0][0]->function_resource(array('name'=>'home_phrase3'),$_smarty_tpl);?>
</span>
								<span class="sh"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['resource'][0][0]->function_resource(array('name'=>'home_phrase3'),$_smarty_tpl);?>
</span>
							</div>
							<div class="s4">
								<span><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['resource'][0][0]->function_resource(array('name'=>'home_phrase4'),$_smarty_tpl);?>
</span>
								<span class="sh"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['resource'][0][0]->function_resource(array('name'=>'home_phrase4'),$_smarty_tpl);?>
</span>
							</div>
						</div>
					</div>
			...
			<div class="content">
				...
				<div class="stores">
					<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['resource'][0][0]->function_resource(array('name'=>'get_link_android'),$_smarty_tpl);?>
" class="android"></a>
					<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['resource'][0][0]->function_resource(array('name'=>'get_link_ios'),$_smarty_tpl);?>
" class="ios"></a>
