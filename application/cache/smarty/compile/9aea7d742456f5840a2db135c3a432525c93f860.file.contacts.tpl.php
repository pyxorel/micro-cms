<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-02-03 13:25:49
         compiled from "D:\workspace\web\test_cms\application\templates\contacts.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1030754d0941d461d41-87149249%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9aea7d742456f5840a2db135c3a432525c93f860' => 
    array (
      0 => 'D:\\workspace\\web\\test_cms\\application\\templates\\contacts.tpl',
      1 => 1422607166,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1030754d0941d461d41-87149249',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54d0941ddf9953_33074721',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54d0941ddf9953_33074721')) {function content_54d0941ddf9953_33074721($_smarty_tpl) {?><?php if (!isset($_smarty_tpl->tpl_vars['doc']->value)) {
...
<div class="content">
				...
				<div class="contacts">
					<p><?php echo $_smarty_tpl->tpl_vars['doc']->value->s_content;?>
</p>
					<div class="cols">
						<div id="map"></div>
						<div class="info">
							<div class="mail">
								<span></span>
								<p class="label"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['resource'][0][0]->function_resource(array('name'=>'contact_label_email'),$_smarty_tpl);?>
</p>
							...
							<div class="phone">
								<span></span>
								<p class="label"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['resource'][0][0]->function_resource(array('name'=>'contact_label_phone'),$_smarty_tpl);?>
</p>
								<p>+7-909-225-6796</p>
							</div>
							<div class="addr">
								<span></span>
								<p class="label"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['resource'][0][0]->function_resource(array('name'=>'contact_label_address'),$_smarty_tpl);?>
</p>
								<p><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['resource'][0][0]->function_resource(array('name'=>'contact_text_address'),$_smarty_tpl);?>
</p>
							</div>
						</div>
					</div>
				...
				<?php echo '<script'; ?>
 type="text/javascript" src="http://api-maps.yandex.ru/2.0-stable/?load=package.standard&lang=ru-RU"><?php echo '</script'; ?>
>
				<?php echo '<script'; ?>
 type="text/javascript">
					$(function(){
