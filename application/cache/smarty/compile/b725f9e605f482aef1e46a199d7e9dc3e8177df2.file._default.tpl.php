<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-02-06 15:06:32
         compiled from "D:\workspace\web\__test_cms\application\templates\_default.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2536854d4a0380d2d11-99423689%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b725f9e605f482aef1e46a199d7e9dc3e8177df2' => 
    array (
      0 => 'D:\\workspace\\web\\__test_cms\\application\\templates\\_default.tpl',
      1 => 1422532707,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2536854d4a0380d2d11-99423689',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54d4a03895dda3_27628431',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54d4a03895dda3_27628431')) {function content_54d4a03895dda3_27628431($_smarty_tpl) {?><?php if (!isset($_smarty_tpl->tpl_vars['doc']->value)) {
...
<div class="content">
	<div class="cols">
		<div class="sidemenu">
			<ul><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['menu'][0][0]->function_menu(array('name'=>'top_menu','out'=>'side_menu'),$_smarty_tpl);?>

				<?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['side_menu']->value->menus; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value) {
$_smarty_tpl->tpl_vars['item']->_loop = true;
?>
					<li><a href="path/<?php echo $_smarty_tpl->tpl_vars['item']->value->route;?>
"><?php echo $_smarty_tpl->tpl_vars['item']->value->name;?>
</a></li>
				<?php } ?>
			</ul>
		</div>
     	<?php $_smarty_tpl->tpl_vars['doc'] = new Smarty_variable(current($_smarty_tpl->tpl_vars['docs']->value), null, 0);?>
		<div class="main">
