...
$lang['reset_password_new_password_label']                    = 'Новый пароль';
$lang['reset_password_new_password_confirm_label']            = 'Подтвердить';
...
$lang['email_activate_subheading'] = 'Пожалуйста перейдите по %s, для активации аккаунта.';
$lang['email_activate_link']       = 'ссылке';

// Forgot Password Email
$lang['email_forgot_password_heading']    = 'Сбросить пароль для %s';
$lang['email_forgot_password_subheading'] = 'Пожалуста перейдите по %s, для сброса пароля.';
...
// Reset Password
$lang['reset_pwd_heading']  = 'Восстановление пароля';
$lang['reset_pwd_reestablish']  = 'Восстановить';
$lang['reset_pwd_text'] = 'Письмо с инструкциями по восстановлению пароля отправлено на ваш email.';

// Activate
$lang['register_activate_head'] = 'Aктивация учетной записи';
$lang['register_activate_text'] = 'На ваш email: %s отправлено письмо с инструкциями по активации учетной записи.';
$lang['register_activate_success'] = 'Регистрация завершена успешно!';
$lang['register_activate_login'] = 'Войти';
$lang['register_activate_error'] = 'Учетная запись уже была активирована, либо ошибка активации.';
