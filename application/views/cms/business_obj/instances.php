    ...
    <div class="container">
        <div class="container buttons">
            <div class="btn-group" style="margin: 10px;">
                <a class="btn dropdown-toggle btn-primary" data-toggle="dropdown" href="#">Добавить объект <span class="caret"></span></a>
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            foreach ($instances as $i=>$item):
                $linkName = anchor('cms/business_obj/edit_instance_view/' . $item->id, isset($item->fields['name']) && !empty($item->fields['name']) ? $item->fields['name']['value'] : $item->id);
                ?>
                <tr>
                    <td><?= ++$x ?></td>
