<script src="<?= base_url('application/content/cms/javaScripts/jquery-ui-1.8.24.custom.min.js') ?>"
        type="text/javascript" charset="utf-8"></script>

<script src="<?= base_url('application/content/cms/javaScripts/jquery.ui.datepicker-ru.js') ?>" type="text/javascript"
...
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container">
            ...
            </a> <a class="brand" href="#" id="logo">MicroCMS</a>
            ...
            <div class="nav-collapse collapse">
                <ul class="nav acc">
                    ...
                    <li class="dropdown" id="preview-menu-seo"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><i
                    ...
                    <li class="dropdown" id="preview-menu-buss"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><i
                                class="icon-suitcase" style="width: auto">
                                Бизнес сущности</i><b class="caret"></b> </a>
                        <ul class="dropdown-menu">
            ...
            <ul class="nav pull-right">
                <li><a href="<?= base_url('cms/auth/change_password') ?>" id="changePwd" class="icon-key"
                       title="Сменить логин/пароль"></a></li>
                <li><a href="<?= base_url('cms/auth/logout') ?>" class="icon-off"
                       title="Выход"></a>
                </li>
            </ul>
        </div>
