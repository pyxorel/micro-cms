...
<fieldset>
    ...
    <div class="control-group">
        ...
        <textarea name="text" cols="15" rows="20" id="text"><?= isset($template) ? htmlentities($template[$key]) : set_value('text') ?></textarea>
    </div>

    <div class="pull-right">
        <input type="submit" value="Применить (Ctrl+S)" id="ok" name="ok" class="btn btn-primary"/>
