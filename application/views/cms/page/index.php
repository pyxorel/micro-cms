...
<div id="wrap">
    <div class="container">
        ...
        <table class="table table-bordered table-striped table-hover">
            <tr class="top">
                <th width="25px">№</th>
                <th><a href="<?=base_url("cms/page/index/0/name/$to/$s_text") ?>">Название <span class="<?=$field=='name' ? $class : NULL?>"></span></a></th>
                <th>Заголовок (Title)</th>
                <th>Примечание ("meta-description")</th>
                <th><a href="<?=base_url("cms/page/index/0/c_time/$to/$s_text") ?>">Дата создания <span class="<?=$field=='c_time' ? $class : NULL?>"></span></a></th>
                <th></th>
            </tr>
            ...
            foreach ($pages as $i=>$item):
                ...
                <tr>
                    ...
                    <td><i class="icon-remove"></i>
                        <?php echo anchor('cms/page/delete/' . $item->id, ' удалить', 'onclick="return confirm(\'Подтверждаете удаление?\') ? true : false;"') ?></td>
                </tr>
            <?php endforeach; ?>
        </table>
