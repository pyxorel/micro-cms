...
class Ion_auth
{
    ...
    public function redirect_to_default_route()
    {
        foreach (array_keys($this->config->item('groups_routes', 'ion_auth')) as $group) {
            if ($this->ion_auth->in_group($group)) {
                redirect($this->config->item('groups_routes', 'ion_auth')[$group]);
            }
        }
    }
